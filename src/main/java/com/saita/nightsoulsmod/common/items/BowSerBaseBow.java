...
public class BowSerBaseBow extends BowItem {

	public BowSerBaseBow(Properties builder) {
		super(builder);
	            ...
	            if (!ammoStack.isEmpty() || hasInfinity) {
	                ...
	                if (!((double)velocity < 0.1D)) {
	                    if (!worldIn.isRemote) {
	                        ...
	                        arrowEntity.setFire(200); // Always a fire Arrow
	                        ...
	                        arrowEntity.pickupStatus = AbstractArrowEntity.PickupStatus.CREATIVE_ONLY; // Can't pick up arrow
	                    ...
	                    // use an arrow
	                    boolean shouldConsumeArrow = false ; //doesn't consume arrows
