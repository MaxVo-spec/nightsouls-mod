...
public class AsteroidSmasher extends SwordItem {

	public AsteroidSmasher(IItemTier tier, int attackDamageIn, float attackSpeedIn, Properties builder) {
    ...
    tooltip.add(new StringTextComponent("§7I just feel bad for mobs at this point. Only §fKrahne§7 can hold this weapon."));
	...
	public void inventoryTick(ItemStack stack, World worldIn, Entity entityIn, int itemSlot, boolean isSelected) {
		...
		if(entityIn instanceof PlayerEntity)
    	{
    	   ...
    	   if(!playerIn.inventory.hasItemStack(new ItemStack(ItemInit.KRAHNE_SOUL.get())))
    	   {
    		  ...
    		  if(((playerIn.getHeldItemMainhand().getItem() == ItemInit.ASTEROID_SMASHER.get())) || 
    			(playerIn.getHeldItemOffhand().getItem() == ItemInit.ASTEROID_SMASHER.get()))
