...
public class MagicMirror extends Item {
    ...
    tooltip.add(new StringTextComponent("§7Gaze in the mirror to teleport to this world's spawn point. Only works if you are in the Overworld. §f10 seconds cooldown."));
