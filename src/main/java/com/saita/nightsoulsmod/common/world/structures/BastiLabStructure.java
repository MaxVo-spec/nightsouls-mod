...
public class BastiLabStructure extends Structure<NoFeatureConfig> {
	
    public BastiLabStructure(Function<Dynamic<?>, ? extends NoFeatureConfig> config)
    {
        super(config);
    }
    ...
    {
        return NightSoulsMod.MOD_ID + ":basti_lab";
    }
    ...
    {
        return BastiLabStructure.Start::new;
    }


    protected int getSeedModifier()
    {
        return 134218228; //2^27 + 500
    }
    ...
    public static class Start extends StructureStart
    {
        ...
        public void init(ChunkGenerator<?> generator, TemplateManager templateManagerIn, int chunkX, int chunkZ, Biome biomeIn)
        {
            ...
            BastiLabPieces.start(templateManagerIn, blockpos, rotation, this.components, this.rand);
