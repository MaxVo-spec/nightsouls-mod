...
public class DragonFossilStructure extends Structure<NoFeatureConfig> {
	
    public DragonFossilStructure(Function<Dynamic<?>, ? extends NoFeatureConfig> config)
    {
        super(config);
    }
    ...
    {
        return NightSoulsMod.MOD_ID + ":dragon_fossil";
    }
    ...
    {
        return DragonFossilStructure.Start::new;
    }


    protected int getSeedModifier()
    {
        return 134217713; //2^27 - 15
    }
    ...
    public static class Start extends StructureStart
    {
        ...
        public void init(ChunkGenerator<?> generator, TemplateManager templateManagerIn, int chunkX, int chunkZ, Biome biomeIn)
        {
            ...
            DragonFossilPieces.start(templateManagerIn, blockpos, rotation, this.components, this.rand);
