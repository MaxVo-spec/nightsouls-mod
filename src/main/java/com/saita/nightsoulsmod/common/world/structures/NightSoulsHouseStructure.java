...
public class NightSoulsHouseStructure extends Structure<NoFeatureConfig> {
	
    public NightSoulsHouseStructure(Function<Dynamic<?>, ? extends NoFeatureConfig> config)
    {
        super(config);
    }
    ...
    {
        return NightSoulsMod.MOD_ID + ":nightsouls_house";
    }
    ...
    {
        return NightSoulsHouseStructure.Start::new;
    }
    ...
    public static class Start extends StructureStart
    {
        ...
        public void init(ChunkGenerator<?> generator, TemplateManager templateManagerIn, int chunkX, int chunkZ, Biome biomeIn)
        {
            ...
            NightSoulsHousePieces.start(templateManagerIn, blockpos, rotation, this.components, this.rand);
