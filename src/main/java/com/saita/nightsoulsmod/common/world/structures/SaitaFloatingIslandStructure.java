...
public class SaitaFloatingIslandStructure extends Structure<NoFeatureConfig> {
	
    public SaitaFloatingIslandStructure(Function<Dynamic<?>, ? extends NoFeatureConfig> config)
    {
        super(config);
    }
    ...
    {
        return NightSoulsMod.MOD_ID + ":saita_floating_island";
    }
    ...
    {
        return SaitaFloatingIslandStructure.Start::new;
    }


    protected int getSeedModifier()
    {
        return 134217792; //2^27 + 64
    }
    ...
    public static class Start extends StructureStart
    {
        ...
        public void init(ChunkGenerator<?> generator, TemplateManager templateManagerIn, int chunkX, int chunkZ, Biome biomeIn)
        {
            ...
            SaitaFloatingIslandPieces.start(templateManagerIn, blockpos, rotation, this.components, this.rand);
