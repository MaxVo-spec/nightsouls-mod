...
public class NightSoulsCampStructure extends Structure<NoFeatureConfig> {
    ...
    public NightSoulsCampStructure(Function<Dynamic<?>, ? extends NoFeatureConfig> config)
    {
        super(config);
    }
    ...
    {
        return NightSoulsMod.MOD_ID + ":nightsouls_camp";
    }
    ...
    public static class Start extends StructureStart
    {
        ...
        public void init(ChunkGenerator<?> generator, TemplateManager templateManagerIn, int chunkX, int chunkZ, Biome biomeIn)
        {
            ...
            NightSoulsCampPieces.start(templateManagerIn, blockpos, rotation, this.components, this.rand);
