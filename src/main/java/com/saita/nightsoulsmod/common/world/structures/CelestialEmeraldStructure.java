...
public class CelestialEmeraldStructure extends Structure<NoFeatureConfig> {
	
    public CelestialEmeraldStructure(Function<Dynamic<?>, ? extends NoFeatureConfig> config)
    {
        super(config);
    }
    ...
    {
        return NightSoulsMod.MOD_ID + ":celestial_emerald";
    }
    ...
    {
        return CelestialEmeraldStructure.Start::new;
    }


    protected int getSeedModifier()
    {
        return 268435446; //2^27 x 2 - 10
    }
    ...
    public static class Start extends StructureStart
    {
        ...
        public void init(ChunkGenerator<?> generator, TemplateManager templateManagerIn, int chunkX, int chunkZ, Biome biomeIn)
        {
            ...
            CelestialEmeraldPieces.start(templateManagerIn, blockpos, rotation, this.components, this.rand);
