...
public class CraneBattleTowerStructure extends Structure<NoFeatureConfig> {
	
    public CraneBattleTowerStructure(Function<Dynamic<?>, ? extends NoFeatureConfig> config)
    {
        super(config);
    }
    ...
    {
        return NightSoulsMod.MOD_ID + ":crane_battle_tower";
    }
    ...
    {
        return CraneBattleTowerStructure.Start::new;
    }


    protected int getSeedModifier()
    {
        return 134217723; //2^27 - 5
    }
    ...
    public static class Start extends StructureStart
    {
        ...
        public void init(ChunkGenerator<?> generator, TemplateManager templateManagerIn, int chunkX, int chunkZ, Biome biomeIn)
        {
            ...
            CraneBattleTowerPieces.start(templateManagerIn, blockpos, rotation, this.components, this.rand);
